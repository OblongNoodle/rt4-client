...
public class SceneGraph {
	...
	public static void clear() {
		...
		occluderCount = 0;
		if (occluders != null) {
			for (local3 = 0; local3 < occluderCount; local3++) {
				occluders[local3] = null;
			}
		}
		if (scenery != null) {
		...
		if (sceneryBuffer != null) {
			for (local3 = 0; local3 < sceneryBuffer.length; local3++) {
				sceneryBuffer[local3] = null;
			}
		}
	}
	...
	public static boolean isOccluded(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < activeOccluderCount; local1++) {
			...
			@Pc(49) int local49;
			@Pc(59) int local59;
			if (local8.direction == 1) {
				local17 = local8.minX - arg0;
				if (local17 > 0) {
					local29 = local8.minY + (local8.nearYSlope * local17 >> 8);
					local39 = local8.maxY + (local8.farYSlope * local17 >> 8);
					local49 = local8.minZ + (local8.nearZSlope * local17 >> 8);
					local59 = local8.maxZ + (local8.farZSlope * local17 >> 8);
					if (arg2 >= local29 && arg2 <= local39 && arg1 >= local49 && arg1 <= local59) {
						return true;
					}
				}
			} else if (local8.direction == 2) {
				local17 = arg0 - local8.minX;
				if (local17 > 0) {
					local29 = local8.minY + (local8.nearYSlope * local17 >> 8);
					local39 = local8.maxY + (local8.farYSlope * local17 >> 8);
					local49 = local8.minZ + (local8.nearZSlope * local17 >> 8);
			...
			} else if (local8.direction == 3) {
				local17 = local8.minY - arg2;
				if (local17 > 0) {
					local29 = local8.minX + (local8.farXSlope * local17 >> 8);
					local39 = local8.maxX + (local8.nearXSlope * local17 >> 8);
					local49 = local8.minZ + (local8.nearZSlope * local17 >> 8);
					local59 = local8.maxZ + (local8.farZSlope * local17 >> 8);
			...
			} else if (local8.direction == 4) {
				local17 = arg2 - local8.minY;
				if (local17 > 0) {
					local29 = local8.minX + (local8.farXSlope * local17 >> 8);
					local39 = local8.maxX + (local8.nearXSlope * local17 >> 8);
					local49 = local8.minZ + (local8.nearZSlope * local17 >> 8);
			...
			} else if (local8.direction == 5) {
				local17 = arg1 - local8.minZ;
				if (local17 > 0) {
					local29 = local8.minX + (local8.farXSlope * local17 >> 8);
					local39 = local8.maxX + (local8.nearXSlope * local17 >> 8);
					local49 = local8.minY + (local8.nearYSlope * local17 >> 8);
					local59 = local8.maxY + (local8.farYSlope * local17 >> 8);
	...
	public static void readTile(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Buffer buffer, @OriginalArg(4) int y, @OriginalArg(5) int x, @OriginalArg(7) int angle, @OriginalArg(8) int level) {
		@Pc(32) int opcode;
		...
		while (true) {
			...
			if (opcode == 0) {
				if (arg2) {
					...
					tileHeights[0][x][y] = -PerlinNoise.getTileHeight(y + arg1 + 556238, arg0 + x + 932731) * 8;
				} else {
	...
	public static void addLoc(@OriginalArg(0) int level, @OriginalArg(2) int arg1, @OriginalArg(3) int shape, @OriginalArg(4) int y, @OriginalArg(5) int layer, @OriginalArg(6) int x, @OriginalArg(7) int arg6) {
		if (x < 0 || y < 0 || x >= 103 || y >= 103) {
			return;
		}
		@Pc(38) int locId;
		if (layer == 0) {
			...
			if (wall != null) {
				...
				if (shape == 2) {
					wall.primary = new Loc(locId, 2, arg1 + 4, level, x, y, arg6, false, wall.primary);
					wall.secondary = new Loc(locId, 2, arg1 + 1 & 0x3, level, x, y, arg6, false, wall.secondary);
				} else {
					wall.primary = new Loc(locId, shape, arg1, level, x, y, arg6, false, wall.primary);
				}
			}
		}
		if (layer == 1) {
			...
			if (wallDecor != null) {
				...
				if (shape == 4 || shape == 5) {
					wallDecor.primary = new Loc(locId, 4, arg1, level, x, y, arg6, false, wallDecor.primary);
				} else if (shape == 6) {
					wallDecor.primary = new Loc(locId, 4, arg1 + 4, level, x, y, arg6, false, wallDecor.primary);
				} else if (shape == 7) {
					wallDecor.primary = new Loc(locId, 4, (arg1 + 2 & 0x3) + 4, level, x, y, arg6, false, wallDecor.primary);
				} else if (shape == 8) {
					wallDecor.primary = new Loc(locId, 4, arg1 + 4, level, x, y, arg6, false, wallDecor.primary);
					wallDecor.secondary = new Loc(locId, 4, (arg1 + 2 & 0x3) + 4, level, x, y, arg6, false, wallDecor.secondary);
				}
			}
		}
		if (layer == 2) {
			...
			if (scenery != null) {
				scenery.entity = new Loc((int) (scenery.key >>> 32) & Integer.MAX_VALUE, shape, arg1, level, x, y, arg6, false, scenery.entity);
			}
		}
		if (layer == 3) {
			@Pc(290) GroundDecor groundDecor = getGroundDecor(level, x, y);
			if (groundDecor != null) {
				groundDecor.entity = new Loc(Integer.MAX_VALUE & (int) (groundDecor.key >>> 32), 22, arg1, level, x, y, arg6, false, groundDecor.entity);
			}
		}
	}

	@OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIILclient!th;JZ)V")
	public static void setGroundDecor(@OriginalArg(0) int level, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int arg3, @OriginalArg(4) Entity entity, @OriginalArg(5) long key, @OriginalArg(6) boolean arg6) {
		if (entity == null) {
			return;
		}
		...
		groundDecor.zFine = arg3;
		groundDecor.key = key;
		groundDecor.flat = arg6;
	...
	public static void setWall(@OriginalArg(0) int level, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int arg3, @OriginalArg(4) Entity primary, @OriginalArg(5) Entity secondary, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) long key) {
		...
		wall.primaryFlags = arg6;
		wall.secondaryFlags = arg7;
				...
				if (local168 >= 0) {
					...
					for (local209 = -5; local209 < 104; local209++) {
						...
						if (local209 >= 0 && local202 > 0) {
							local142[local168][local209] = ColorUtils.packHsl(overlay / local202, local178 / local202, local173 * 256 / local200);
						}
					}
				}
			}
						...
						if (local178 > 0 || overlay > 0) {
							...
							if (overlay == 0) {
								...
								if (GlRenderer.enabled && local152 > 0 && local234 != -1 && FluTypeList.get(local178 - 1).blockShadow) {
									ShadowManager.addFloorShadow(0, 0, true, false, local168, local173, local200 - tileHeights[0][local168][local173], -tileHeights[0][local168 + 1][local173] + local202, local209 - tileHeights[0][local168 + 1][local173 + 1], local349 - tileHeights[0][local168][local173 + 1]);
								}
								if (GlRenderer.enabled && !underwater && tileWaterData != null && local152 == 0) {
									for (local322 = local168 - 1; local322 <= local168 + 1; local322++) {
										for (@Pc(1794) int local1794 = local173 - 1; local1794 <= local173 + 1; local1794++) {
											if ((local322 != local168 || local173 != local1794) && local322 >= 0 && local322 < 104 && local1794 >= 0 && local1794 < 104) {
												...
												if (local1834 != 0) {
													@Pc(1842) FloType local1842 = FloTypeList.get(local1834 - 1);
													if (local1842.texture != -1 && Rasteriser.textureProvider.getMaterialType(local1842.texture) == MaterialManager.WATER) {
														tileWaterData[local168][local173] = local1842.waterColor + (local1842.waterOpacity << 24);
														continue label771;
													}
												}
											}
								...
								@Pc(1248) FloType local1248 = FloTypeList.get(overlay - 1);
								...
								if (GlRenderer.enabled && !underwater && tileWaterData != null && local152 == 0) {
									if (local1248.texture != -1 && Rasteriser.textureProvider.getMaterialType(local1248.texture) == MaterialManager.WATER) {
										tileWaterData[local168][local173] = (local1248.waterOpacity << 24) + local1248.waterColor;
									} else {
										label737:
										for (texture = local168 - 1; texture <= local168 + 1; texture++) {
											for (local1301 = local173 - 1; local1301 <= local173 + 1; local1301++) {
												if ((local168 != texture || local1301 != local173) && texture >= 0 && texture < 104 && local1301 >= 0 && local1301 < 104) {
													...
													if (local1353 != 0) {
														@Pc(1366) FloType local1366 = FloTypeList.get(local1353 - 1);
														if (local1366.texture != -1 && Rasteriser.textureProvider.getMaterialType(local1366.texture) == MaterialManager.WATER) {
															tileWaterData[local168][local173] = local1366.waterColor + (local1366.waterOpacity << 24);
															break label737;
														}
													}
												}
			...
			if (GlRenderer.enabled) {
				...
				while (true) {
					if (local200 > 103) {
						...
						if (underwater) {
							local2025 = buildGlPlainTiles(renderFlags, tileShapes[local152], tileUnderlays[local152], local146, local1896, tileWaterData, tileOverlays[local152], tileAngles[local152], local1888, local152, local1900, local142, tileHeights[local152], surfaceTileHeights[0]);
				...
				for (local168 = 0; local168 <= 104; local168++) {
					if ((occludeFlags[local152][local168][local2204] & 0x1) != 0) {
						...
						if (local202 >= 8) {
							...
							Occluder.add(1, local168 * 128, local168 * 128, local173 * 128, local178 * 128 + 128, local349, local234);
					...
					if ((occludeFlags[local152][local168][local2204] & 0x2) != 0) {
						...
						if (local202 >= 8) {
							...
							Occluder.add(2, local173 * 128, local178 * 128 + 128, local2204 * 128, local2204 * 128, local349, local234);
							for (local254 = overlay; local254 <= local200; local254++) {
								for (local267 = local173; local267 <= local178; local267++) {
					...
					if ((occludeFlags[local152][local168][local2204] & 0x4) != 0) {
						...
						if ((local178 + 1 - local173) * (local200 - (overlay - 1)) >= 4) {
							...
							Occluder.add(4, local173 * 128, local178 * 128 + 128, overlay * 128, local200 * 128 + 128, local202, local202);
	...
	public static void setUnderwaterHdTiles(@OriginalArg(0) int arg0, @OriginalArg(1) GlTile[] arg1) {
		underwaterHdTiles[arg0] = arg1;
	}

	@OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIII)V")
	public static void setTile(@OriginalArg(0) int level, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19) {
		...
		if (arg3 == 0) {
			...
			@Pc(134) ShapedTile local134 = new ShapedTile(arg3, arg4, arg5, x, y, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19);
			for (level0 = level; level0 >= 0; level0--) {
				if (tiles[level0][x][y] == null) {
					tiles[level0][x][y] = new Tile(level0, x, y);
				}
			}
			tiles[level][x][y].shapedTile = local134;
		}
	}
		...
		for (@Pc(1) int level = 0; level < levels; level++) {
			for (@Pc(6) int x = 0; x < width; x++) {
				for (@Pc(11) int y = 0; y < length; y++) {
					@Pc(22) Tile local22 = tiles[level][x][y];
					if (local22 != null) {
						@Pc(27) Wall local27 = local22.wall;
						if (local27 != null && local27.primary.canMerge()) {
							mergeEntityNormals(local27.primary, level, x, y, 1, 1);
							if (local27.secondary != null && local27.secondary.canMerge()) {
								mergeEntityNormals(local27.secondary, level, x, y, 1, 1);
						...
						for (@Pc(83) int local83 = 0; local83 < local22.sceneryLen; local83++) {
							...
							if (local92 != null && local92.entity.canMerge()) {
								mergeEntityNormals(local92.entity, level, x, y, local92.xMax + 1 - local92.xMin, local92.yMax - local92.yMin + 1);
						...
						if (local131 != null && local131.entity.canMerge()) {
							mergeGroundDecorNormals(local131.entity, level, x, y);
	...
	public static boolean addSceneryEntity(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Entity arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) long arg11) {
		...
		local58.zFine = arg7;
		local58.entity = arg8;
		local58.orientation = arg9;
		local58.xMin = arg1;
		local58.yMin = arg2;
		local58.xMax = arg1 + arg3 - 1;
		local58.yMax = arg2 + arg4 - 1;
		@Pc(108) int local108;
		for (local17 = arg1; local17 < arg1 + arg3; local17++) {
			for (local108 = arg2; local108 < arg2 + arg4; local108++) {
				...
				local174.sceneryLen++;
				if (local6 && tileWaterData[local17][local108] != 0) {
					local8 = tileWaterData[local17][local108];
				}
			}
		}
		if (local6 && local8 != 0) {
			for (local17 = arg1; local17 < arg1 + arg3; local17++) {
				for (local108 = arg2; local108 < arg2 + arg4; local108++) {
					if (tileWaterData[local17][local108] == 0) {
						tileWaterData[local17][local108] = local8;
					}
				}
			}
		}
	...
	public static void addGroundDecorEntity(@OriginalArg(1) int y, @OriginalArg(2) int x, @OriginalArg(3) int level, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) CollisionMap collision) {
		@Pc(9) long key = 0L;
		if (arg3 == 0) {
		...
		if (shape == 2) {
			if (local100 instanceof Loc) {
				...
				Loc.buildStaticShadow(type, 0, angle + 4, 0, shape, x, y, arg4);
			}
			if (local102 instanceof Loc) {
				((Loc) local102).resetShadow();
			} else {
				Loc.buildStaticShadow(type, 0, angle + 1 & 0x3, 0, shape, x, y, arg4);
			}
		} else if (shape == 5) {
			if (local100 instanceof Loc) {
				((Loc) local100).resetShadow();
			} else {
				Loc.buildStaticShadow(type, WALL_DECO_ROT_SIZE_Y_DIR[angle] * 8, angle, WALL_DECO_ROT_SIZE_X_DIR[angle] * 8, 4, x, y, arg4);
			}
		} else if (shape == 6) {
			if (local100 instanceof Loc) {
				((Loc) local100).resetShadow();
			} else {
				Loc.buildStaticShadow(type, WALL_OFFSET_Y[angle] * 8, angle + 4, WALL_OFFSET_X[angle] * 8, 4, x, y, arg4);
			}
		} else if (shape == 7) {
			if (local100 instanceof Loc) {
				((Loc) local100).resetShadow();
			} else {
				Loc.buildStaticShadow(type, 0, (angle + 2 & 0x3) + 4, 0, 4, x, y, arg4);
			}
		} else if (shape == 8) {
			if (local100 instanceof Loc) {
				((Loc) local100).resetShadow();
			...
			if (local102 instanceof Loc) {
				...
				Loc.buildStaticShadow(type, WALL_OFFSET_Y[angle] * 8, (angle + 2 & 0x3) + 4, WALL_OFFSET_X[angle] * 8, 4, x, y, arg4);
			}
		} else if (shape == 11) {
			if (local100 instanceof Loc) {
				((Loc) local100).resetShadow();
			} else {
				Loc.buildStaticShadow(type, 0, angle + 4, 0, 10, x, y, arg4);
			}
		} else if (local100 instanceof Loc) {
			((Loc) local100).resetShadow();
		} else {
			Loc.buildStaticShadow(type, 0, angle, 0, shape, x, y, arg4);
		}
	}
	...
	public static void bridgeTile(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(9) int local9 = 0; local9 < 3; local9++) {
			...
			if (local30 != null) {
				...
				for (@Pc(40) int local40 = 0; local40 < local30.sceneryLen; local40++) {
					...
					if ((local49.key >> 29 & 0x3L) == 2L && local49.xMin == arg0 && local49.yMin == arg1) {
						local49.level--;
					}
				}
			}
		...
		tiles[0][arg0][arg1].linkedTile = local7;
		...
		if (arg1 != arg2 || arg3 != arg4) {
			for (local16 = arg1; local16 <= arg2; local16++) {
				for (local20 = arg3; local20 <= arg4; local20++) {
					if (occlusionCache[arg0][local16][local20] == -drawCycle) {
						return false;
					}
				}
			}
	...
	public static void setWallDecor(@OriginalArg(0) int level, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int arg3, @OriginalArg(4) Entity primary, @OriginalArg(5) Entity secondary, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int xOffset, @OriginalArg(9) int yOffset, @OriginalArg(10) long key) {
		if (primary == null) {
			return;
		}
		...
		wallDecor.orientation = arg3;
		wallDecor.primary = primary;
		wallDecor.secondary = secondary;
		wallDecor.flags = arg6;
		wallDecor.zFine = arg7;
	...
	public static void renderTile(@OriginalArg(0) Tile arg0, @OriginalArg(1) boolean arg1) {
		...
		while (true) {
				...
				do {
					do {
						do {
							do {
								do {
									while (true) {
										...
										while (true) {
											do {
												local8 = (Tile) tileQueue.removeHead();
												if (local8 == null) {
													return;
												}
											} while (!local8.checkedBelowLevel);
											local18 = local8.x;
											local21 = local8.y;
											local24 = local8.drawLevel;
											local27 = local8.level;
											local31 = tiles[local24];
											@Pc(33) float local33 = 0.0F;
											if (GlRenderer.enabled) {
												if (underwaterTileHeights == tileHeights) {
													var9 = tileWaterData[local18][local21];
													var10 = var9 & 0xFFFFFF;
													...
													local65 = var9 >>> 24 << 3;
													if (local65 != lastUnderwaterFogRange) {
														lastUnderwaterFogRange = local65;
														MaterialManager.setUnderwaterFogRange(local65);
													}
											...
											if (arg1) {
												if (local24 > 0) {
													...
													if (local153 != null && local153.checkedBelowLevel) {
														continue;
													}
												}
												if (local18 <= cameraTileX && local18 > LightingManager.visibleMinX) {
													local153 = local31[local18 - 1][local21];
													if (local153 != null && local153.checkedBelowLevel && (local153.visible || (local8.allInteriorFlags & 0x1) == 0)) {
														continue;
													}
												}
												if (local18 >= cameraTileX && local18 < LightingManager.visibleMaxX - 1) {
													local153 = local31[local18 + 1][local21];
													if (local153 != null && local153.checkedBelowLevel && (local153.visible || (local8.allInteriorFlags & 0x4) == 0)) {
														continue;
													}
												}
												if (local21 <= cameraTileY && local21 > LightingManager.visibleMinY) {
													local153 = local31[local18][local21 - 1];
													if (local153 != null && local153.checkedBelowLevel && (local153.visible || (local8.allInteriorFlags & 0x8) == 0)) {
														continue;
													}
												}
												if (local21 >= cameraTileY && local21 < LightingManager.visibleMaxY - 1) {
													local153 = local31[local18][local21 + 1];
													if (local153 != null && local153.checkedBelowLevel && (local153.visible || (local8.allInteriorFlags & 0x2) == 0)) {
														continue;
													}
												}
											} else {
											...
											if (local8.linkedTile != null) {
												...
												if (local153.plainTile == null) {
													if (local153.shapedTile != null) {
														drawShapedTile(local153.shapedTile, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, 0, isTileOccluded(0, local18, local21));
													}
												} else
													drawPlainTile(local153.plainTile, 0, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, isTileOccluded(0, local18, local21));
												var22 = local153.wall;
												if (var22 != null) {
													if (GlRenderer.enabled) {
													...
													var22.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, var22.xFine - cameraX, var22.zFine - cameraZ, var22.yFine - cameraY, var22.key, local24, null);
												}
												for (local65 = 0; local65 < local153.sceneryLen; local65++) {
													...
													if (var25 != null) {
														...
														var25.entity.render(var25.orientation, sinPitch, cosPitch, sinYaw, cosYaw, var25.xFine - cameraX, var25.zFine - cameraZ, var25.yFine - cameraY, var25.key, local24, null);
													}
												}
												if (GlRenderer.enabled) {
													GlRenderer.setDepthLayer(local33);
											...
											if (local8.plainTile == null) {
												if (local8.shapedTile != null) {
													if (isTileOccluded(local27, local18, local21)) {
														drawShapedTile(local8.shapedTile, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, local27, true);
													} else {
														var24 = true;
														drawShapedTile(local8.shapedTile, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, local27, false);
													}
												}
											} else if (isTileOccluded(local27, local18, local21)) {
												drawPlainTile(local8.plainTile, local27, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, true);
											} else {
												var24 = true;
												if (local8.plainTile.colorNE != 12345678 || MiniMenu.walkPending && local24 <= MiniMenu.walkDestPlane) {
													drawPlainTile(local8.plainTile, local27, sinPitch, cosPitch, sinYaw, cosYaw, local18, local21, false);
												}
											}
											if (var24) {
												...
												if (local549 != null && (local549.key & 0x80000000L) != 0L) {
													...
													local549.entity.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local549.xFine - cameraX, local549.zFine - cameraZ, local549.yFine - cameraY, local549.key, local24, null);
													if (GlRenderer.enabled && local549.flat) {
														GlRenderer.setDepthLayer(local33);
													}
												}
											...
											if (local616 != null || local619 != null) {
												if (cameraTileX == local18) {
													var10++;
												} else if (cameraTileX < local18) {
													var10 += 2;
												}
												if (cameraTileY == local21) {
													var10 += 3;
											...
											if (local616 != null) {
												...
												if ((local616.primaryFlags & local65) != 0 && !isWallVisible(local27, local18, local21, local616.primaryFlags)) {
													...
													local616.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local616.xFine - cameraX, local616.zFine - cameraZ, local616.yFine - cameraY, local616.key, local24, null);
												}
												if ((local616.secondaryFlags & local65) != 0 && !isWallVisible(local27, local18, local21, local616.secondaryFlags)) {
													if (GlRenderer.enabled) {
														LightingManager.updateLightsForTile(cameraX, cameraZ, cameraY, local24, local18, local21);
													}
													local616.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local616.xFine - cameraX, local616.zFine - cameraZ, local616.yFine - cameraY, local616.key, local24, null);
												}
											}
											if (local619 != null && !isTileVisible(local27, local18, local21, local619.primary.getMinY())) {
												...
												if ((local619.flags & local65) != 0) {
													...
													local619.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local619.xFine + local619.xOffset - cameraX, local619.orientation - cameraZ, local619.yFine + local619.yOffset - cameraY, local619.key, local24, null);
												} else if (local619.flags == 256) {
													local894 = local619.xFine - cameraX;
													local899 = local619.orientation - cameraZ;
													local904 = local619.yFine - cameraY;
													var17 = local619.zFine;
													if (var17 == 1 || var17 == 2) {
														var18 = -local894;
													} else {
														var18 = local894;
													...
													if (local928 < var18) {
														...
														local619.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local894 + local619.xOffset, local899, local904 + local619.yOffset, local619.key, local24, null);
													} else if (local619.secondary != null) {
														if (GlRenderer.enabled) {
															LightingManager.updateLightsForTile(cameraX, cameraZ, cameraY, local24, local18, local21);
														}
														local619.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local894, local899, local904, local619.key, local24, null);
													}
												}
												if (GlRenderer.enabled) {
													GlRenderer.setDepthLayer(local33);
											...
											if (var24) {
												...
												if (local1001 != null && (local1001.key & 0x80000000L) == 0L) {
													...
													local1001.entity.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1001.xFine - cameraX, local1001.zFine - cameraZ, local1001.yFine - cameraY, local1001.key, local24, null);
													if (GlRenderer.enabled && local1001.flat) {
														GlRenderer.setDepthLayer(local33);
													}
												}
												@Pc(1064) ObjStackEntity local1064 = local8.objStack;
												if (local1064 != null && local1064.heightOffset == 0) {
													if (GlRenderer.enabled) {
														LightingManager.updateLightsForTile(cameraX, cameraZ, cameraY, local24, local18, local21);
													}
													if (local1064.secondary != null) {
														local1064.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1064.xFine - cameraX, local1064.zFine - cameraZ, local1064.yFine - cameraY, local1064.key, local24, null);
													}
													if (local1064.tertiary != null) {
														local1064.tertiary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1064.xFine - cameraX, local1064.zFine - cameraZ, local1064.yFine - cameraY, local1064.key, local24, null);
													}
													if (local1064.primary != null) {
														local1064.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1064.xFine - cameraX, local1064.zFine - cameraZ, local1064.yFine - cameraY, local1064.key, local24, null);
													}
												}
											}
											local894 = local8.allInteriorFlags;
											if (local894 != 0) {
												if (local18 < cameraTileX && (local894 & 0x4) != 0) {
													var32 = local31[local18 + 1][local21];
													if (var32 != null && var32.checkedBelowLevel) {
														tileQueue.addTail(var32);
													}
												}
												if (local21 < cameraTileY && (local894 & 0x2) != 0) {
													var32 = local31[local18][local21 + 1];
													if (var32 != null && var32.checkedBelowLevel) {
														tileQueue.addTail(var32);
													}
												}
												if (local18 > cameraTileX && (local894 & 0x1) != 0) {
													var32 = local31[local18 - 1][local21];
													if (var32 != null && var32.checkedBelowLevel) {
														tileQueue.addTail(var32);
													}
												}
												if (local21 > cameraTileY && (local894 & 0x8) != 0) {
													var32 = local31[local18][local21 - 1];
													if (var32 != null && var32.checkedBelowLevel) {
														tileQueue.addTail(var32);
													}
										...
										if (local8.sceneryDrawFlags != 0) {
											var24 = true;
											for (var10 = 0; var10 < local8.sceneryLen; var10++) {
												if (local8.scenery[var10].drawCycle != drawCycle && (local8.interiorFlags[var10] & local8.sceneryDrawFlags) == local8.sceneryDrawnDirFlags) {
													var24 = false;
													break;
												}
											}
										...
										if (!local8.hasUpdated) {
											break;
										}
										try {
											var9 = local8.sceneryLen;
											local8.hasUpdated = false;
											var10 = 0;
											label767:
											for (local65 = 0; local65 < var9; local65++) {
												...
												if (var25.drawCycle != drawCycle) {
													for (local1332 = var25.xMin; local1332 <= var25.xMax; local1332++) {
														for (local894 = var25.yMin; local894 <= var25.yMax; local894++) {
															var32 = local31[local1332][local894];
															if (var32.visible) {
																local8.hasUpdated = true;
																continue label767;
															}
															if (var32.sceneryDrawFlags != 0) {
																...
																if (local894 > var25.yMin) {
																	local904 += 8;
																}
																if (local894 < var25.yMax) {
																	local904 += 2;
																}
																if ((local904 & var32.sceneryDrawFlags) == local8.scenerySkipDirFlags) {
																	local8.hasUpdated = true;
																	continue label767;
																}
															}
													...
													local1332 = cameraTileX - var25.xMin;
													local894 = var25.xMax - cameraTileX;
													if (local894 > local1332) {
														local1332 = local894;
													}
													local899 = cameraTileY - var25.yMin;
													local904 = var25.yMax - cameraTileY;
													if (local904 > local899) {
														var25.drawPriority = local1332 + local904;
													} else {
														var25.drawPriority = local1332 + local899;
													}
												}
											}
											while (var10 > 0) {
												...
												for (local1332 = 0; local1332 < var10; local1332++) {
													@Pc(1628) Scenery local1628 = sceneryBuffer[local1332];
													if (local1628.drawCycle != drawCycle) {
														if (local1628.drawPriority > local65) {
															local65 = local1628.drawPriority;
															local115 = local1332;
														} else if (local1628.drawPriority == local65) {
															local899 = local1628.xFine - cameraX;
															local904 = local1628.yFine - cameraY;
															var17 = sceneryBuffer[local115].xFine - cameraX;
															var18 = sceneryBuffer[local115].yFine - cameraY;
												...
												@Pc(1697) Scenery local1697 = sceneryBuffer[local115];
												local1697.drawCycle = drawCycle;
												if (!isAreaVisible(local27, local1697.xMin, local1697.xMax, local1697.yMin, local1697.yMax, local1697.entity.getMinY())) {
													...
													local1697.entity.render(local1697.orientation, sinPitch, cosPitch, sinYaw, cosYaw, local1697.xFine - cameraX, local1697.zFine - cameraZ, local1697.yFine - cameraY, local1697.key, local24, null);
												}
												for (local894 = local1697.xMin; local894 <= local1697.xMax; local894++) {
													for (local899 = local1697.yMin; local899 <= local1697.yMax; local899++) {
														@Pc(1863) Tile local1863 = local31[local894][local899];
														if (local1863.sceneryDrawFlags != 0) {
															tileQueue.addTail(local1863);
														} else if ((local894 != local18 || local899 != local21) && local1863.checkedBelowLevel) {
															tileQueue.addTail(local1863);
														}
													}
												}
							...
							} while (local8.sceneryDrawFlags != 0);
							if (local18 > cameraTileX || local18 <= LightingManager.visibleMinX) {
								break;
							}
							local153 = local31[local18 - 1][local21];
						} while (local153 != null && local153.checkedBelowLevel);
						if (local18 < cameraTileX || local18 >= LightingManager.visibleMaxX - 1) {
							break;
						}
						local153 = local31[local18 + 1][local21];
			...
			local8.checkedBelowLevel = false;
			visibleTileCount--;
			@Pc(1999) ObjStackEntity local1999 = local8.objStack;
			if (local1999 != null && local1999.heightOffset != 0) {
				if (GlRenderer.enabled) {
					LightingManager.updateLightsForTile(cameraX, cameraZ, cameraY, local24, local18, local21);
				}
				if (local1999.secondary != null) {
					local1999.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1999.xFine - cameraX, local1999.zFine - cameraZ - local1999.heightOffset, local1999.yFine - cameraY, local1999.key, local24, null);
				}
				if (local1999.tertiary != null) {
					local1999.tertiary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1999.xFine - cameraX, local1999.zFine - cameraZ - local1999.heightOffset, local1999.yFine - cameraY, local1999.key, local24, null);
				}
				if (local1999.primary != null) {
					local1999.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local1999.xFine - cameraX, local1999.zFine - cameraZ - local1999.heightOffset, local1999.yFine - cameraY, local1999.key, local24, null);
				}
			}
			if (local8.wallDrawFlags != 0) {
				...
				if (local2109 != null && !isTileVisible(local27, local18, local21, local2109.primary.getMinY())) {
					if ((local2109.flags & local8.wallDrawFlags) != 0) {
						...
						local2109.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local2109.xFine + local2109.xOffset - cameraX, local2109.orientation - cameraZ, local2109.yFine + local2109.yOffset - cameraY, local2109.key, local24, null);
					} else if (local2109.flags == 256) {
						local65 = local2109.xFine - cameraX;
						local115 = local2109.orientation - cameraZ;
						local1332 = local2109.yFine - cameraY;
						local894 = local2109.zFine;
						...
						if (local904 >= local899) {
							...
							local2109.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local65 + local2109.xOffset, local115, local1332 + local2109.yOffset, local2109.key, local24, null);
						} else if (local2109.secondary != null) {
							if (GlRenderer.enabled) {
								LightingManager.updateLightsForTile(cameraX, cameraZ, cameraY, local24, local18, local21);
							}
							local2109.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local65, local115, local1332, local2109.key, local24, null);
						}
					}
				}
				...
				if (local2275 != null) {
					if ((local2275.secondaryFlags & local8.wallDrawFlags) != 0 && !isWallVisible(local27, local18, local21, local2275.secondaryFlags)) {
						...
						local2275.secondary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local2275.xFine - cameraX, local2275.zFine - cameraZ, local2275.yFine - cameraY, local2275.key, local24, null);
					}
					if ((local2275.primaryFlags & local8.wallDrawFlags) != 0 && !isWallVisible(local27, local18, local21, local2275.primaryFlags)) {
						...
						local2275.primary.render(0, sinPitch, cosPitch, sinYaw, cosYaw, local2275.xFine - cameraX, local2275.zFine - cameraZ, local2275.yFine - cameraY, local2275.key, local24, null);
					}
				}
			}
			...
			if (local24 < levels - 1) {
				...
				if (local2388 != null && local2388.checkedBelowLevel) {
					tileQueue.addTail(local2388);
				}
			}
			if (local18 < cameraTileX) {
				local2388 = local31[local18 + 1][local21];
				if (local2388 != null && local2388.checkedBelowLevel) {
					tileQueue.addTail(local2388);
				}
			}
			if (local21 < cameraTileY) {
	...
	public static void addLoc(@OriginalArg(0) int currentPlane, @OriginalArg(1) boolean lowmem, @OriginalArg(2) int plane, @OriginalArg(3) boolean highmem, @OriginalArg(4) CollisionMap map, @OriginalArg(5) int locIndex, @OriginalArg(6) int locType, @OriginalArg(7) int x, @OriginalArg(9) int y, @OriginalArg(10) int orientation) {
		...
		@Pc(173) int local173 = (length << 6) + (y << 7);
		...
		if (locType == LocType.GROUNDDECOR) {
			if (Preferences.showGroundDecorations || loc.interactable != 0 || loc.blockwalk == 1 || loc.forcedecor) {
				if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
					...
					if (GlRenderer.enabled && local330) {
						ShadowManager.addObjectShadow(local403.sprite, local165, diffAverageY, local173);
					}
			...
			if (entity != null) {
				@Pc(531) boolean local531 = addEntity(plane, x, y, averageY, width, length, entity, bitset);
				if (loc.active && local531 && lowmem) {
					...
					for (@Pc(560) int local560 = 0; local560 <= width; local560++) {
						for (@Pc(565) int local565 = 0; local565 <= length; local565++) {
							if (shadowmap[plane][x + local560][local565 + y] < local541) {
								shadowmap[plane][x + local560][y + local565] = (byte) local541;
							}
						}
					}
				}
			...
			if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
				...
				if (GlRenderer.enabled && local330) {
					ShadowManager.addObjectShadow(local1287.sprite, local165, diffAverageY, local173);
				}
				...
				local1254 = new Loc(locIndex, LocType.WALL_L, orientation + 4, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
				local1269 = new Loc(locIndex, LocType.WALL_L, local1226, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
			}
			setWall(plane, x, y, averageY, local1254, local1269, WALL_ROTATION_TYPE1[orientation], WALL_ROTATION_TYPE1[local1226], bitset);
			...
			local1226 = 16;
			local1889 = getWallKey(plane, x, y);
			if (local1889 != 0L) {
			...
			if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
				...
				if (GlRenderer.enabled && local330) {
					ShadowManager.addObjectShadow(local1950.sprite, local165 - WALL_DECO_ROT_SIZE_X_DIR[orientation] * 8, diffAverageY, local173 - WALL_DECO_ROT_SIZE_Y_DIR[orientation] * 8);
				}
				local1934 = local1950.model;
			} else {
				local1934 = new Loc(locIndex, 4, orientation, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
			}
			setWallDecor(plane, x, y, averageY, local1934, null, WALL_ROTATION_TYPE1[orientation], 0, local1226 * WALL_DECO_ROT_SIZE_X_DIR[orientation], WALL_DECO_ROT_SIZE_Y_DIR[orientation] * local1226, bitset);
			...
			if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
				...
				if (GlRenderer.enabled && local330) {
					ShadowManager.addObjectShadow(local1950.sprite, local165 - WALL_OFFSET_X[orientation] * 8, diffAverageY, local173 - WALL_OFFSET_Y[orientation] * 8);
				}
				local1934 = local1950.model;
			} else {
				local1934 = new Loc(locIndex, 4, orientation + 4, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
			}
			setWallDecor(plane, x, y, averageY, local1934, null, 256, orientation, local1226 * WALL_OFFSET_X[orientation], local1226 * WALL_OFFSET_Y[orientation], bitset);
			...
			if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
				...
				if (GlRenderer.enabled && local330) {
					ShadowManager.addObjectShadow(local2183.sprite, local165, diffAverageY, local173);
				}
				entity = local2183.model;
			} else {
				entity = new Loc(locIndex, 4, local2137 + 4, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
			}
			setWallDecor(plane, x, y, averageY, entity, null, 256, local2137, 0, 0, bitset);
			...
			if (loc.anim == -1 && loc.multiLocs == null && !loc.dynamic) {
				@Pc(2297) int local2297 = WALL_OFFSET_Y[orientation] * 8;
				@Pc(2303) int local2303 = WALL_OFFSET_X[orientation] * 8;
				...
				if (GlRenderer.enabled && local330) {
					ShadowManager.addObjectShadow(local2319.sprite, local165 - local2303, diffAverageY, local173 - local2297);
				}
				...
				local1934 = new Loc(locIndex, 4, orientation + 4, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
				local2289 = new Loc(locIndex, 4, local2244 + 4, currentPlane, x, y, loc.anim, loc.allowrandomizedanimation, null);
			}
			setWallDecor(plane, x, y, averageY, local1934, local2289, 256, orientation, local1226 * WALL_OFFSET_X[orientation], WALL_OFFSET_Y[orientation] * local1226, bitset);
		}
	}
	...
	public static void setPlainTile(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte[][][] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int arg11, @OriginalArg(12) byte arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		sinPitch = MathUtils.sin[arg3];
		cosPitch = MathUtils.cos[arg3];
		sinYaw = MathUtils.sin[arg4];
		cosYaw = MathUtils.cos[arg4];
		cameraX = arg0;
		cameraZ = arg1;
		cameraY = arg2;
		cameraTileX = arg0 / 128;
		cameraTileY = arg2 / 128;
		...
		for (local104 = 0; local104 < visibility + visibility + 2; local104++) {
			for (local113 = 0; local113 < visibility + visibility + 2; local113++) {
				...
				@Pc(140) int local140 = (local113 - visibility << 7) - (cameraY & 0x7F);
				@Pc(146) int local146 = cameraTileX + local104 - visibility;
				@Pc(152) int local152 = cameraTileY + local113 - visibility;
				if (local146 >= 0 && local152 >= 0 && local146 < width && local152 < length) {
					@Pc(176) int local176;
					if (underwaterTileHeights == null) {
						local176 = surfaceTileHeights[0][local146][local152] + 128 - cameraZ;
					} else {
						local176 = underwaterTileHeights[0][local146][local152] + 128 - cameraZ;
					}
					@Pc(201) int local201 = surfaceTileHeights[3][local146][local152] - cameraZ - 1000;
					visibilityPoints[local104][local113] = projectToScreen(local130, local201, local176, local140, local99);
				} else {
					visibilityPoints[local104][local113] = false;
				}
			}
		}
	...
	public static void setShapedTile(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[][][] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(37) int local37;
		@Pc(183) int local183;
		for (@Pc(23) int local23 = startLevel; local23 < levels; local23++) {
			@Pc(30) Tile[][] local30 = tiles[local23];
			for (local32 = LightingManager.visibleMinX; local32 < LightingManager.visibleMaxX; local32++) {
				for (local37 = LightingManager.visibleMinY; local37 < LightingManager.visibleMaxY; local37++) {
					@Pc(46) Tile local46 = local30[local32][local37];
					if (local46 != null) {
						if (visibleTiles[local32 + visibility - cameraTileX][local37 + visibility - cameraTileY] && (arg3 == null || local23 < arg4 || arg3[local23][local32][local37] != arg5)) {
							local46.visible = true;
							local46.checkedBelowLevel = true;
							local46.hasUpdated = local46.sceneryLen > 0;
							visibleTileCount++;
						} else {
							local46.visible = false;
							local46.checkedBelowLevel = false;
							local46.sceneryDrawFlags = 0;
							if (local32 >= local9 && local32 <= local13 && local37 >= local17 && local37 <= local21) {
								if (local46.wall != null) {
									@Pc(103) Wall local103 = local46.wall;
									local103.primary.updateModel(0, local23, local103.zFine, local103.xFine, local103.yFine);
									if (local103.secondary != null) {
										local103.secondary.updateModel(0, local23, local103.zFine, local103.xFine, local103.yFine);
									}
								}
								if (local46.wallDecor != null) {
									@Pc(134) WallDecor local134 = local46.wallDecor;
									local134.primary.updateModel(local134.zFine, local23, local134.orientation, local134.xFine, local134.yFine);
									if (local134.secondary != null) {
										local134.secondary.updateModel(local134.zFine, local23, local134.orientation, local134.xFine, local134.yFine);
									}
								}
								if (local46.groundDecor != null) {
									@Pc(167) GroundDecor local167 = local46.groundDecor;
									local167.entity.updateModel(0, local23, local167.zFine, local167.xFine, local167.yFine);
								}
								if (local46.scenery != null) {
									for (local183 = 0; local183 < local46.sceneryLen; local183++) {
										...
										local192.entity.updateModel(local192.orientation, local23, local192.zFine, local192.xFine, local192.yFine);
									}
								}
							}
						}
		...
		if (GlRenderer.enabled) {
			...
			if (local240) {
				...
				for (local32 = 0; local32 < underwaterHdTiles[0].length; local32++) {
					...
					if (local285.underwaterColor != lastUnderwaterColor) {
						lastUnderwaterColor = local285.underwaterColor;
				...
				while (true) {
					...
					if (local32 == 0 && Preferences.sceneryShadowsType > 0) {
						...
						ShadowManager.renderShadowMapGL(cameraTileX, cameraTileY, visibility, arg1, visibleTiles, tileHeights[0]);
					}
					local32++;
				}
			}
		...
		@Pc(415) int local415;
		@Pc(428) int local428;
		for (local399 = startLevel; local399 < levels; local399++) {
			local406 = tiles[local399];
			for (local37 = -visibility; local37 <= 0; local37++) {
				local415 = cameraTileX + local37;
				local183 = cameraTileX - local37;
				if (local415 >= LightingManager.visibleMinX || local183 < LightingManager.visibleMaxX) {
					for (local428 = -visibility; local428 <= 0; local428++) {
						local434 = cameraTileY + local428;
						local438 = cameraTileY - local428;
						if (local415 >= LightingManager.visibleMinX) {
							if (local434 >= LightingManager.visibleMinY) {
								local450 = local406[local415][local434];
								if (local450 != null && local450.visible) {
									renderTile(local450, true);
								}
							}
							if (local438 < LightingManager.visibleMaxY) {
						...
						if (local183 < LightingManager.visibleMaxX) {
							if (local434 >= LightingManager.visibleMinY) {
	...
	public static void setObjStack(@OriginalArg(0) int level, @OriginalArg(1) int x, @OriginalArg(2) int y, @OriginalArg(3) int arg3, @OriginalArg(4) Entity primary, @OriginalArg(5) long arg5, @OriginalArg(6) Entity secondary, @OriginalArg(7) Entity tertiary) {
		...
		@Pc(34) int local34 = 0;
		@Pc(42) Tile local42 = tiles[level][x][y];
		if (local42 != null) {
							...
							if (local39 >= 0 && local39 < length && (!local1 || local28 >= local7 || local39 >= local15 || local39 < arg3 && local28 != arg2)) {
								...
								if (local71 != null) {
									...
									for (@Pc(232) int local232 = 0; local232 < local71.sceneryLen; local232++) {
										...
										if (local241 != null && local241.entity.canMerge() && (local28 == local241.xMin || local28 == local3) && (local39 == local241.yMin || local39 == local11)) {
											@Pc(270) int local270 = local241.xMax + 1 - local241.xMin;
											@Pc(278) int local278 = local241.yMax + 1 - local241.yMin;
											arg0.mergeNormals(local241.entity, (local241.xMin - arg2) * 128 + (local270 - arg4) * 64, local158, (local241.yMin - arg3) * 128 + (local278 - arg5) * 64, local1);
										}
									}
								}
							}
	...
	public static void setWallDecoration(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (local13 != null) {
			...
			local13.yOffset = local13.yOffset * arg3 / 16;
		}
	}
	...
	public static void buildGlLighting(@OriginalArg(0) float[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) byte[][] arg2, @OriginalArg(3) Light[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[][] arg6, @OriginalArg(7) byte[][] arg7, @OriginalArg(8) byte[][] arg8, @OriginalArg(9) int[][] arg9, @OriginalArg(11) float[][] arg10) {
		for (@Pc(7) int local7 = 0; local7 < arg5; local7++) {
			...
			if (local18.level == arg4) {
				...
				@Pc(46) int local46 = (local18.y >> 7) - local18.radius;
				if (local46 < 0) {
					local24 = -local46;
					local46 = 0;
				}
				@Pc(65) int local65 = local18.radius + (local18.y >> 7);
				if (local65 > 103) {
					local65 = 103;
				}
				@Pc(72) int local72;
				...
				for (local72 = local46; local72 <= local65; local72++) {
					...
					for (local114 = local90; local114 <= local99; local114++) {
						...
						if (local125 == 0) {
							...
							local151 = FloTypeList.get(local133 - 1);
				...
				local24 = 0;
				local28.allocate();
				if ((local18.y >> 7) - local18.radius < 0) {
		...
		for (@Pc(11) int local11 = 1; local11 <= 103; local11++) {
			for (local16 = 1; local16 <= 103; local16++) {
				...
				if (local25 != 0) {
					...
					local9[local11][local16] = (local77.texture + 1 << 16) + local77.textureScale;
				}
			}
		}
		...
		for (local16 = 1; local16 <= 102; local16++) {
			for (local112 = 1; local112 <= 102; local112++) {
				if (arg2[local16][local112] != 0) {
					...
					local233.faceCapacity++;
					local233.vertexCapacity += local219;
	...
	public static void drawPlainTile(@OriginalArg(0) PlainTile arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8) {
		...
		@Pc(14) int local14;
		@Pc(15) int local15 = local14 = (arg7 << 7) - cameraY;
		@Pc(20) int local20;
		@Pc(21) int local21 = local20 = local7 + 128;
		@Pc(26) int local26;
		@Pc(27) int local27 = local26 = local15 + 128;
		@Pc(37) int local37 = tileHeights[arg1][arg6][arg7] - cameraZ;
		@Pc(49) int local49 = tileHeights[arg1][arg6 + 1][arg7] - cameraZ;
		@Pc(63) int local63 = tileHeights[arg1][arg6 + 1][arg7 + 1] - cameraZ;
		@Pc(75) int local75 = tileHeights[arg1][arg6][arg7 + 1] - cameraZ;
		...
		if ((local307 - local323) * (local299 - local331) - (local315 - local331) * (local291 - local323) > 0) {
			...
			if (!GlRenderer.enabled && !arg8) {
				...
				if (arg0.textureId == -1) {
					if (arg0.colorNE != 12345678) {
						Rasteriser.fillGouraudTriangle(local315, local331, local299, local307, local323, local291, arg0.colorNE, arg0.colorNW, arg0.colorSE);
					}
				} else if (!Preferences.manyGroundTextures) {
					local475 = Rasteriser.textureProvider.getAverageColor(arg0.textureId);
					Rasteriser.fillGouraudTriangle(local315, local331, local299, local307, local323, local291, ColorUtils.multiplyLightness3(local475, arg0.colorNE), ColorUtils.multiplyLightness3(local475, arg0.colorNW), ColorUtils.multiplyLightness3(local475, arg0.colorSE));
				} else if (arg0.flat) {
					Rasteriser.fillTexturedTriangle(local315, local331, local299, local307, local323, local291, arg0.colorNE, arg0.colorNW, arg0.colorSE, local97, local21, local241, local119, local49, local85, local117, local165, local261, arg0.textureId);
				} else {
					Rasteriser.fillTexturedTriangle(local315, local331, local299, local307, local323, local291, arg0.colorNE, arg0.colorNW, arg0.colorSE, local193, local241, local21, local63, local85, local49, local27, local261, local165, arg0.textureId);
				}
			}
		}
		...
		if (arg0.textureId == -1) {
			if (arg0.colorSW != 12345678) {
				Rasteriser.fillGouraudTriangle(local283, local299, local331, local275, local291, local323, arg0.colorSW, arg0.colorSE, arg0.colorNW);
			}
		} else if (Preferences.manyGroundTextures) {
			Rasteriser.fillTexturedTriangle(local283, local299, local331, local275, local291, local323, arg0.colorSW, arg0.colorSE, arg0.colorNW, local97, local21, local241, local119, local49, local85, local117, local165, local261, arg0.textureId);
		} else {
			local475 = Rasteriser.textureProvider.getAverageColor(arg0.textureId);
			Rasteriser.fillGouraudTriangle(local283, local299, local331, local275, local291, local323, ColorUtils.multiplyLightness3(local475, arg0.colorSW), ColorUtils.multiplyLightness3(local475, arg0.colorSE), ColorUtils.multiplyLightness3(local475, arg0.colorNW));
		}
	}
	...
	public static boolean isTileOccluded(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(7) int local7 = occlusionCache[arg0][arg1][arg2];
		if (local7 == -drawCycle) {
			return false;
		} else if (local7 == drawCycle) {
			return true;
		} else {
			...
			if (isOccluded(local22 + 1, tileHeights[arg0][arg1][arg2], local26 + 1) && isOccluded(local22 + 128 - 1, tileHeights[arg0][arg1 + 1][arg2], local26 + 1) && isOccluded(local22 + 128 - 1, tileHeights[arg0][arg1 + 1][arg2 + 1], local26 + 128 - 1) && isOccluded(local22 + 1, tileHeights[arg0][arg1][arg2 + 1], local26 + 128 - 1)) {
				occlusionCache[arg0][arg1][arg2] = drawCycle;
				return true;
			} else {
				occlusionCache[arg0][arg1][arg2] = -drawCycle;
				return false;
	...
	public static boolean projectToScreen(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(9) int local9 = arg3 * sinYaw + arg0 * cosYaw >> 16;
		@Pc(19) int local19 = arg3 * cosYaw - arg0 * sinYaw >> 16;
		@Pc(29) int local29 = arg1 * sinPitch + local19 * cosPitch >> 16;
		@Pc(39) int local39 = arg1 * cosPitch - local19 * sinPitch >> 16;
		if (local29 < 1) {
			local29 = 1;
		}
		@Pc(50) int local50 = (local9 << 9) / local29;
		@Pc(56) int local56 = (local39 << 9) / local29;
		@Pc(66) int local66 = arg2 * sinPitch + local19 * cosPitch >> 16;
		@Pc(76) int local76 = arg2 * cosPitch - local19 * sinPitch >> 16;
		if (local66 < 1) {
			local66 = 1;
		}
	...
	public static void buildActiveOccluders() {
		...
		for (@Pc(3) int local3 = 0; local3 < occluderCount; local3++) {
			...
			if (local10.type == 1) {
				local14 = local10.minTileX + visibility - cameraTileX;
				if (local14 >= 0 && local14 <= visibility + visibility) {
					local115 = local10.minTileY + visibility - cameraTileY;
					if (local115 < 0) {
						local115 = 0;
					}
					local126 = local10.maxTileY + visibility - cameraTileY;
					if (local126 > visibility + visibility) {
						local126 = visibility + visibility;
					}
					local137 = false;
					while (local115 <= local126) {
						if (visibleTiles[local14][local115++]) {
							local137 = true;
							break;
						}
					}
					if (local137) {
						local158 = cameraX - local10.minX;
						if (local158 > 32) {
							local10.direction = 1;
						} else {
							if (local158 >= -32) {
						...
						local10.nearYSlope = (local10.minY - cameraY << 8) / local158;
						local10.farYSlope = (local10.maxY - cameraY << 8) / local158;
						local10.nearZSlope = (local10.minZ - cameraZ << 8) / local158;
						local10.farZSlope = (local10.maxZ - cameraZ << 8) / local158;
						activeOccluders[activeOccluderCount++] = local10;
					}
				}
			} else if (local10.type == 2) {
				local14 = local10.minTileY + visibility - cameraTileY;
				if (local14 >= 0 && local14 <= visibility + visibility) {
					local115 = local10.minTileX + visibility - cameraTileX;
					if (local115 < 0) {
						local115 = 0;
					}
					local126 = local10.maxTileX + visibility - cameraTileX;
					if (local126 > visibility + visibility) {
						local126 = visibility + visibility;
					}
					local137 = false;
					while (local115 <= local126) {
						if (visibleTiles[local115++][local14]) {
							local137 = true;
							break;
						}
					}
					if (local137) {
						local158 = cameraY - local10.minY;
						if (local158 > 32) {
							local10.direction = 3;
						} else {
							if (local158 >= -32) {
						...
						local10.farXSlope = (local10.minX - cameraX << 8) / local158;
						local10.nearXSlope = (local10.maxX - cameraX << 8) / local158;
						local10.nearZSlope = (local10.minZ - cameraZ << 8) / local158;
						local10.farZSlope = (local10.maxZ - cameraZ << 8) / local158;
						activeOccluders[activeOccluderCount++] = local10;
					}
				}
			} else if (local10.type == 4) {
				local14 = local10.minZ - cameraZ;
				if (local14 > 128) {
					local115 = local10.minTileY + visibility - cameraTileY;
					if (local115 < 0) {
						local115 = 0;
					...
					if (local115 <= local126) {
						@Pc(408) int local408 = local10.minTileX + visibility - cameraTileX;
						if (local408 < 0) {
							local408 = 0;
						}
						local158 = local10.maxTileX + visibility - cameraTileX;
						...
						for (@Pc(432) int local432 = local408; local432 <= local158; local432++) {
							for (@Pc(437) int local437 = local115; local437 <= local126; local437++) {
								if (visibleTiles[local432][local437]) {
									local430 = true;
									break label166;
								}
							}
						...
						if (local430) {
							local10.direction = 5;
							local10.farXSlope = (local10.minX - cameraX << 8) / local14;
							local10.nearXSlope = (local10.maxX - cameraX << 8) / local14;
							local10.nearYSlope = (local10.minY - cameraY << 8) / local14;
							local10.farYSlope = (local10.maxY - cameraY << 8) / local14;
							activeOccluders[activeOccluderCount++] = local10;
						}
					}
				}
	...
	public static void drawShapedTile(@OriginalArg(0) ShapedTile arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, int arg7, @OriginalArg(7) boolean arg8) {
		...
		for (local5 = 0; local5 < local3; local5++) {
			local15 = arg0.vertexX[local5] - cameraX;
			local22 = arg0.vertexY[local5] - cameraZ;
			local29 = arg0.vertexZ[local5] - cameraY;
		...
		for (local5 = 0; local5 < local3; local5++) {
			...
			if ((local39 - local148) * (local164 - local160) - (local156 - local160) * (local152 - local148) > 0) {
				...
				if (!GlRenderer.enabled && !arg8) {
					...
					if (arg0.triangleTextureId == null || arg0.triangleTextureId[local5] == -1) {
						if (arg0.triangleColorA[local5] != 12345678) {
							Rasteriser.fillGouraudTriangle(local156, local160, local164, local39, local148, local152, arg0.triangleColorA[local5], arg0.triangleColorB[local5], arg0.triangleColorC[local5]);
						}
					} else if (!Preferences.manyGroundTextures) {
	...
	public static GlTile[] buildGlShapedTiles(@OriginalArg(0) float[][] arg0, @OriginalArg(1) float[][] arg1, @OriginalArg(2) int[][] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float[][] arg4, @OriginalArg(5) byte[][] arg5, @OriginalArg(6) int[][] arg6, @OriginalArg(8) byte[][] arg7, @OriginalArg(9) byte[][] arg8, @OriginalArg(10) byte[][] arg9, @OriginalArg(11) byte[][][] arg10) {
		...
		for (local12 = 1; local12 <= 102; local12++) {
			for (local17 = 1; local17 <= 102; local17++) {
				...
				if (local38 != 0) {
					@Pc(50) FloType local50 = FloTypeList.get(local38 - 1);
				...
				if ((arg8[local12][local17] & 0xFF) != 0 || local38 != 0 && arg7[local12][local17] == 0) {
					...
					if (local180 != 0 && local38 != local180) {
						local242 = FloTypeList.get(local180 - 1);
					...
					if (local214 != 0 && local214 != local38) {
						local242 = FloTypeList.get(local214 - 1);
						if (local242.blendTexture && local242.baseColor != -1) {
							local264 = arg5[local12 - 1][local17 - 1];
							local274 = arg7[local12 - 1][local17 - 1];
					...
					if (local202 != 0 && local38 != local202) {
						local242 = FloTypeList.get(local202 - 1);
						if (local242.blendTexture && local242.baseColor != -1) {
							local264 = arg5[local12 + 1][local17 - 1];
							local274 = arg7[local12 + 1][local17 - 1];
					...
					if (local226 != 0 && local226 != local38) {
						local242 = FloTypeList.get(local226 - 1);
						if (local242.blendTexture && local242.baseColor != -1) {
							local264 = arg5[local12 + 1][local17 + 1];
							local274 = arg7[local12 + 1][local17 + 1];
							local299 = overlayEdgeLookup[local274 * 4 + (local264 + 1 & 0x3)];
					...
					for (local1035 = 0; local1035 < local127; local1035++) {
						...
						local1097.vertexCapacity += local1077.length - 2;
						local1097.vertexCapacity += local1055.length - 2;
						local1097.vertexCapacity += local1068.length - 2;
						local1097.vertexCapacity += local1086.length - 2;
						local1097.faceCapacity++;
					}
				}
			}
		}
		...
		for (local12 = 1; local12 <= 102; local12++) {
			for (local17 = 1; local17 <= 102; local17++) {
				...
				if (local127 != 0) {
					@Pc(1250) FloType local1250 = FloTypeList.get(local127 - 1);
				...
				if ((arg8[local12][local17] & 0xFF) != 0 || local127 != 0 && arg7[local12][local17] == 0) {
					...
					if (local214 == 0 || local214 == local127) {
						...
						local1496 = FloTypeList.get(local214 - 1);
					...
					if (local202 == 0 || local127 == local202) {
						...
						local1496 = FloTypeList.get(local202 - 1);
						if (local1496.blendTexture && local1496.baseColor != -1) {
							local274 = arg5[local12 - 1][local17 - 1];
							local1527 = arg7[local12 - 1][local17 - 1];
					...
					if (local226 == 0 || local226 == local127) {
						...
						local1496 = FloTypeList.get(local226 - 1);
						if (local1496.blendTexture && local1496.baseColor != -1) {
							local274 = arg5[local12 + 1][local17 - 1];
							local1527 = arg7[local12 + 1][local17 - 1];
					...
					if (local1035 == 0 || local127 == local1035) {
						...
						local1496 = FloTypeList.get(local1035 - 1);
						if (local1496.blendTexture && local1496.baseColor != -1) {
							local1527 = arg7[local12 + 1][local17 + 1];
							local274 = arg5[local12 + 1][local17 + 1];
	...
	public static void readTerrain(@OriginalArg(0) CollisionMap[] arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) byte[] arg6) {
				...
				if (local168 == 0) {
					...
					while (local243 < local188) {
						while (local190 < local194) {
							occlusionHeights[local117][local243][local190] = 0;
							local190++;
						}
						local243++;
					}
							...
							for (local194 = local243 + arg4; local194 < arg4 + local243 + 4; local194++) {
								for (@Pc(320) int local320 = arg3 + local188; local320 < arg3 + local188 + 4; local320++) {
									if (local194 >= 0 && local194 < 104 && local320 >= 0 && local320 < 104) {
										occlusionHeights[local117][local194][local320] = local305;
									}
								}
							}
						}
					...
					while (local188 > local243) {
						while (local190 < local194) {
							occlusionHeights[local117][local243][local190] = occlusionHeights[local117 - 1][local243][local190];
							local190++;
						}
						local243++;
					}
		...
		if (GlRenderer.enabled && !arg1) {
			...
			while (true) {
				...
				int regionY = (arg3 + Camera.originY) >> 6;
			...
			for (local117 = 0; local117 < 16; local117++) {
				for (local515 = 0; local515 < 16; local515++) {
					...
					if (local243 >= 0 && local243 < 26 && local188 >= 0 && local188 < 26) {
						occlusionHeights[local21][local243][local188] = 0;
					}
				}
			}
		}
	...
	public static void readDynamicTerrain(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) CollisionMap[] arg3, @OriginalArg(4) int arg4, @OriginalArg(6) byte[] arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) boolean arg9) {
			...
			for (local103 = 0; local103 < 64; local103++) {
				for (local108 = 0; local108 < 64; local108++) {
					if (arg6 == local17 && arg8 <= local103 && arg8 + 8 > local103 && arg7 <= local108 && local108 < arg7 + 8) {
						readTile(0, 0, arg9, local96, rotateY(arg0, local103 & 0x7, local108 & 0x7) + arg4, rotateX(arg0, local108 & 0x7, local103 & 0x7) + arg1, arg0, arg2);
					} else {
					...
					if (local108 <= arg6) {
						...
						while (local237 > local232) {
							while (local417 < local255) {
								occlusionHeights[arg2][local232][local417] = 0;
								local417++;
							}
							local232++;
						}
								...
								for (local255 = local232; local255 < local232 + 4; local255++) {
									for (local266 = local237; local266 < local237 + 4; local266++) {
										if (local255 >= arg8 && local255 < arg8 + 8 && local266 >= arg7 && arg7 + 8 > arg7) {
											...
											@Pc(328) int local328 = rotateY(arg0, local255 & 0x7, local266 & 0x7) + arg4;
											if (local316 >= 0 && local316 < 104 && local328 >= 0 && local328 < 104) {
												occlusionHeights[arg2][local316][local328] = local246;
											}
										}
									}
								}
			...
			while (true) {
				...
				for (local232 = 0; local232 < local497; local232++) {
					...
					if (arg6 == local517.level && local417 >= arg8 && arg8 + 8 > local417 && arg7 <= local255 && arg7 + 8 > local255) {
						local266 = rotateXFine(arg0, local517.x & 0x3FF, local517.y & 0x3FF) + (arg1 << 7);
						local316 = rotateYFine(local517.x & 0x3FF, arg0, local517.y & 0x3FF) + (arg4 << 7);
						local517.x = local266;
						local517.y = local316;
						local417 = local517.x >> 7;
						local255 = local517.y >> 7;
		...
		for (local497 = arg1; local497 < local103; local497++) {
			for (local232 = arg4; local232 < local108; local232++) {
				occlusionHeights[arg2][local497][local232] = 0;
			}
		}
	}

	@OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZII)I")
	public static int rotateX(@OriginalArg(0) int arg0, @OriginalArg(2) int y, @OriginalArg(3) int x) {
	...
	public static int rotateY(@OriginalArg(0) int arg0, @OriginalArg(2) int x, @OriginalArg(3) int y) {
		@Pc(3) int angle = arg0 & 0x3;
		if (angle == 0) {
			return y;
		} else if (angle == 1) {
	...
	public static int rotateXFine(@OriginalArg(0) int arg0, @OriginalArg(1) int x, @OriginalArg(3) int y) {
		@Pc(3) int angle = arg0 & 0x3;
		if (angle == 0) {
			return x;
		} else if (angle == 1) {
	...
	public static int rotateYFine(@OriginalArg(0) int x, @OriginalArg(1) int arg1, @OriginalArg(3) int y) {
