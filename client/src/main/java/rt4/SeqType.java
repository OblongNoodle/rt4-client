...
public final class SeqType {
	...
	public Model animateLocSoftware(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Model arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (local41 == null) {
			local124 = arg2.copyForLoc(!local23.isAlphaTransformed(local27), !local23.isColorTransformed(local27), !this.hasModelTransforms);
		} else {
			local124 = arg2.copyForLoc(!local23.isAlphaTransformed(local27) & !local41.isAlphaTransformed(arg1), !local23.isColorTransformed(local27) & !local41.isColorTransformed(arg1), !this.hasModelTransforms);
		}
		...
		local124.applyAnimation(local23, local27, local41, arg1, arg4 - 1, local10, this.hasModelTransforms);
		if (GlRenderer.enabled && this.hasModelTransforms) {
			if (local39 == 1) {
				((GlModel) local124).rotateCounterClockwiseAll();
			} else if (local39 == 2) {
	...
	public Model animateEntity(@OriginalArg(0) Model arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		@Pc(258) Model local258 = arg0.copyForEntity(local163, local172, !this.hasModelTransforms);
		local258.applyAnimation(local19, local23, local34, arg1, arg2 - 1, local13, this.hasModelTransforms);
		if (local71 != null) {
			local258.applyAnimation(local71, local83, local81, local85, arg2 - 1, local13, this.hasModelTransforms);
		}
		return local258;
	}
	...
	public Model animateLocGl(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Model arg4) {
		...
		if (local42 == null) {
			local106 = arg4.copyForEntity(!local19.isAlphaTransformed(local27), !local19.isColorTransformed(local27), !this.hasModelTransforms);
		} else {
			local106 = arg4.copyForEntity(!local19.isAlphaTransformed(local27) & !local42.isAlphaTransformed(arg0), !local19.isColorTransformed(local27) & !local42.isColorTransformed(arg0), !this.hasModelTransforms);
		}
		...
		local106.applyAnimation(local19, local27, local42, arg0, arg2 - 1, local6, this.hasModelTransforms);
		if (this.hasModelTransforms && GlRenderer.enabled) {
			if (local40 == 1) {
				((GlModel) local106).rotateCounterClockwiseAll();
			} else if (local40 == 2) {
	...
	public Model animateSpotAnim(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Model arg3) {
		...
		if (local42 == null) {
			local103 = arg3.copyForAnimation(!local27.isAlphaTransformed(local31), !local27.isColorTransformed(local31), !this.hasModelTransforms);
		} else {
			local103 = arg3.copyForAnimation(!local27.isAlphaTransformed(local31) & !local42.isAlphaTransformed(arg0), !local27.isColorTransformed(local31) & !local42.isColorTransformed(arg0), !this.hasModelTransforms);
		}
		local103.applyAnimation(local27, local31, local42, arg0, arg1 - 1, local16, this.hasModelTransforms);
		return local103;
	}
