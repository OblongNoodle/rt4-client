...
public class ColorUtils {
	...
	public static float[] getRgbFloat(@OriginalArg(0) int arg0) {
		...
		rgbaBuffer[1] = local7 * (float) (arg0 >> 8 & 0xFF) / 255.0F * local33 * local11;
		rgbaBuffer[0] = local7 * local11 * local24 * ((float) (arg0 >> 16 & 0xFF) / 255.0F);
		@Pc(74) float local74 = (float) (local9 & 0xFF) / 255.0F;
		rgbaBuffer[2] = (float) (arg0 & 0xFF) / 255.0F * local74 * local11 * local7;
		return rgbaBuffer;
	}
